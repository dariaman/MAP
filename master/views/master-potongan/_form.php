...
<div class="master-potongan-form">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="table table-striped table-bordered">
                        <tr>
                            <td style="width:200px;">ID Potongan</td>  
                            <td><?=(Yii::$app->controller->action->id == 'update') ? $model->IDPotongan :'[Auto Generate]' ?></td>
                        </tr>
                        <tr>
                             <td>Deskripsi Potongan</td>
