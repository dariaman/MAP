...
<div class="transaction-master-view">
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box-body">
                <?php
                    echo Html::a('Approve', ['approve-soh', 'transid' => $model->TransID, 'action'=> 'A'], [
                            'class' => 'btn btn-success',
                            'data' => [
                                'method' => 'post',
                            ],
                        ]);
                    echo Html::a('Reject', ['correction-soh','transid'=>$model->TransID],['class' => 'btn btn-success','data' => ['method' => 'post']]);
