...
<div class="transaction-master-view">
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box-body">
                <?php
                    if(substr($model->TransID, 0,3) == 'SOH') {
                        echo Html::a('Approve', ['approve-so', 'transid' => $model->TransID, 'action'=> 'A'], [
                    ...
                    echo Html::a('Reject', ['correction-so','transid'=>$model->TransID],['class' => 'btn btn-success','data' => ['method' => 'post']]);
