...
<div class="box-body">
    ...
    echo Html::dropDownList('typeSearch', $type, ['od.OfferingDID' => 'Offering Detail',
        'ma.AreaID' => 'Area ID',
        'ma.Description' => 'Area Name',
        'od.Class' => 'Class'], ['prompt' => 'ALL', 'class' => 'form-control', 'id' => 'searchdrop']);
