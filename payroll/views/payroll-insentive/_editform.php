...
$this->title = 'Edit Payroll Sensitive';
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            <td>Product Name</td>
                            <td><?= $form->field($model, 'namaprod')->textInput(['readonly' => true,  'style' => "width:260px", 'name' => 'prod-name-payroll']) ?> </td>
                        </tr>
                        <tr>
                            <td>Job Description</td>
                            <td><?= $form->field($model, 'jobdesk')->textInput(['readonly' => true, 'style' => "width:260px", 'name' => 'prod-jobdesk-payroll']) ?> </td>
                        </tr>
                        <tr>
